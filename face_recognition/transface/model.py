...
def load_transface():
    ...
    model.load_state_dict(torch.load("C:\\Users\\jerne\\Desktop\\FAKS\\MAG2\\Biometricni_sistemi\\BS_projekt\\experimental_tools\\face_recognition\\transface\\weights.pt"))
