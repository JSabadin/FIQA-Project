...
def load_adaface():
    ...
    statedict = torch.load('C:\\Users\\jerne\\Desktop\\FAKS\\MAG2\\Biometricni_sistemi\\BS_projekt\\experimental_tools\\face_recognition\\adaface\\weights.ckpt')['state_dict']
